...
Possible amélioration : 
    - mettre les 2 version dans un seul fichier et laisser au joueur le choix du mode
    - faire qu'executer le fichier lance le jeu directement
"""
...
def newGame():
    ...
    randomText = soup.find('div', id="randomtext_box").get_text().replace('\n','').replace('\r','') #This variable holds the text generated by the site
    
    #Getting rid of potential blank spaces at the beginning of the paragraph
    blank = 0
    char = randomText[blank]
    
    #Getting rid of potential empty characters at the beginning of the paragraph
    while char == "\t":
        blank += 1
        char = randomText[blank]
        
    n = blank + 20*timeLimit
    char = randomText[n]
